...
public class Coche extends Combustible{

	public Coche(int idVehiculo, int numRuedas, int precioAlquiler, String marca, String modelo, String color,
	...
	public String toString() {
		return "Coche [matricula=" + matricula + ", tipoCombustible=" + tipoCombustible + ", numPuertas=" + numPuertas
